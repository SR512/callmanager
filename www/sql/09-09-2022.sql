...
MySQL - 10.5.15-MariaDB-log : Database - test_callmanager
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`test_callmanager` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `test_callmanager`;
